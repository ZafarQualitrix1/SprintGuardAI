...
// AES-256-GCM envelope encryption (Solution Architecture §18 Credential Vault). The configured
// CREDENTIAL_ENCRYPTION_KEY is hashed to a fixed 32-byte key via SHA-256 so any sufficiently
// random string works as the source secret without the operator needing to produce exactly 32
