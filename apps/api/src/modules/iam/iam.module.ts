...
import { GOOGLE_IDENTITY_VERIFIER } from './application/ports/google-identity-verifier.port';
import {
  USER_REPOSITORY,
...
import { GoogleIdentityVerifierService } from './infrastructure/services/google-identity-verifier.service';
...
@Module({
  imports: [PassportModule, OrganizationSettingsModule, EmailModule],
  ...
  providers: [
    ...
    { provide: GOOGLE_IDENTITY_VERIFIER, useClass: GoogleIdentityVerifierService },
